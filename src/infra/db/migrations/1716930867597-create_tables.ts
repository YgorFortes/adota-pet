...
export class CreateTables1716930867597 implements MigrationInterface {
    name = 'CreateTables1716930867597'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_80e1ff45d1324b428780eacb7a" ON "pet" ("shelter_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_bd8c777a49a848117e9fc0a19c" ON "pet" ("guardian_id") `);
        ...
        await queryRunner.query(`CREATE TABLE "address" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "city" character varying(45) NOT NULL, "cep" character varying(45), "state" character varying(45) NOT NULL, "square" character varying(45) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "pet" ADD CONSTRAINT "FK_bd8c777a49a848117e9fc0a19c4" FOREIGN KEY ("guardian_id") REFERENCES "guardian"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "shelter" ADD CONSTRAINT "FK_642eb6002341a37b7851c45e4ec" FOREIGN KEY ("address_id") REFERENCES "address"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "guardian" ADD CONSTRAINT "FK_d1c3a36be489a1b09c9ee631fe7" FOREIGN KEY ("address_id") REFERENCES "address"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
