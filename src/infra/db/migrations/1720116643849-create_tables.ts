...
export class CreateTables1720116643849 implements MigrationInterface {
    name = 'CreateTables1720116643849'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pet" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "birth_date" TIMESTAMP, "image" character varying(255) NOT NULL, "size" "public"."pet_size_enum" NOT NULL, "behavior" character varying(100) NOT NULL, "status" "public"."pet_status_enum" DEFAULT 'não adotado', "specie" "public"."pet_specie_enum" NOT NULL, "shelter_id" uuid, CONSTRAINT "PK_b1ac2e88e89b9480e0c5b53fa60" PRIMARY KEY ("id"))`);
